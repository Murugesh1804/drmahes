// server/auth.js — JWT authentication helpers (password-only)
...
/**
 * POST /api/auth/login — Password-only authentication
 * Validates password. On success, issues JWT immediately (no OTP).
 */
async function handleLogin(req, res) {
  try {
    ...
    console.log('[auth] Password verified — JWT issued')

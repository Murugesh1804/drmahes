    ...
    <>
      ...
      <div className={`mobile-nav ${mobileNavOpen ? "open" : ""}`} id="mobileNav" role="dialog" aria-label="Mobile navigation">
        ...
        <div className="mobile-nav-contacts">
          ...
          <a href="https://wa.me/919342803217" target="_blank" rel="nofollow noopener noreferrer" className="btn btn-whatsapp" style={{ width: '100%' }}>
      ...
      <div className="mobile-float-bar" aria-label="Quick mobile contacts">
        ...
        <a href="https://wa.me/919342803217" target="_blank" rel="nofollow noopener noreferrer" className="mobile-float-btn" aria-label="WhatsApp clinic">
